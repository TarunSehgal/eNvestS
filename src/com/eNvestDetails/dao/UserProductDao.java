...
public class UserProductDao {
	...
	public List<UserProductDTO> getAllProduct(Long userKey) throws EnvestException{
	...
	public UserProductDTO getProduct(String userId) throws EnvestException{
	...
	public int addNewProduct(UserProductDTO productDTO, MessageFactory message) throws EnvestException{
